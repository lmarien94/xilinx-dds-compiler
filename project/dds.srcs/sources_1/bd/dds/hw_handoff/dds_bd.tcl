...
proc create_root_design { parentCell } {
  ...
  set m_axis_data_tdata [ create_bd_port -dir O -from 15 -to 0 m_axis_data_tdata ]
  set m_axis_data_tready [ create_bd_port -dir I m_axis_data_tready ]
  ...
  connect_bd_net -net aclken_0_1 [get_bd_ports aclken] [get_bd_pins dds_compiler_0/aclken]
  connect_bd_net -net clk_wiz_0_clk_35 [get_bd_pins clk_wiz_0/clk_10] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  ...
  connect_bd_net -net m_axis_data_tready_0_1 [get_bd_ports m_axis_data_tready] [get_bd_pins dds_compiler_0/m_axis_data_tready]
